...
CREATE TABLE ATH_PERMISSIONS (
    ...
    UPDATED_AT      TIMESTAMP(6),
    DELETED_AT      TIMESTAMP(6),
    CONSTRAINT UK_ATH_PERMISSIONS_RESOURCE_ACTION UNIQUE (TENANT_ID, RESOURCE_NAME, ACTION),
...
/
CREATE INDEX IDX_ATH_PERMISSIONS_RESOURCE   ON ATH_PERMISSIONS (RESOURCE_NAME)
/
...
CREATE TABLE ATH_TENANT_SSO_CONFIG (
    ...
    SSO_TYPE            VARCHAR2(20)  NOT NULL
        CONSTRAINT CK_ATH_SSO_TYPE CHECK (sso_type IN ('INTERNAL', 'KEYCLOAK', 'LDAP', 'JWT_SSO', 'CAS', 'REST_TOKEN', 'HTTP_FORM')),
