...
CREATE TABLE ATH_ORGANIZATION (
    ...
    ACTIVE                 CHAR          DEFAULT 'Y'         NOT NULL
        CONSTRAINT CK_ATH_ORG_ACTIVE CHECK (active IN ('Y', 'N')),
...
/
COMMENT ON COLUMN ATH_ORGANIZATION.ACTIVE IS '활성화 여부: Y/N'
/
...
CREATE TABLE ATH_USER_ORGANIZATION (
    ...
    IS_PRIMARY      CHAR          DEFAULT 'N'         NOT NULL
        CONSTRAINT CK_ATH_USER_ORG_PRIMARY CHECK (is_primary IN ('Y', 'N')),
    POSITION        VARCHAR2(100),
    START_DATE      DATE,
    END_DATE        DATE,
    ACTIVE          CHAR          DEFAULT 'Y'         NOT NULL
        CONSTRAINT CK_ATH_USER_ORG_ACTIVE CHECK (active IN ('Y', 'N')),
    CREATED_BY      VARCHAR2(50)                      NOT NULL,
    CREATED_AT      TIMESTAMP(6)  DEFAULT SYSTIMESTAMP NOT NULL,
    UPDATED_BY      VARCHAR2(50),
    UPDATED_AT      TIMESTAMP(6),
...
/
COMMENT ON COLUMN ATH_USER_ORGANIZATION.IS_PRIMARY IS '주 소속 여부: Y(주 소속), N(겸임)'
/
...
/
COMMENT ON COLUMN ATH_USER_ORGANIZATION.ACTIVE IS '활성화 여부: Y/N'
/
